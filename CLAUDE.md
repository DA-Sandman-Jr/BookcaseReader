...
- `BookshelfReader.Extensions/` exposes service-registration helpers and is packable.
...
- Keep the consumer-facing NuGet surface in `BookshelfReader.Extensions/` and `BookshelfReader.Api/`.
