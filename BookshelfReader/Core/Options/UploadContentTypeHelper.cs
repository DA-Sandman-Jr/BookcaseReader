...
public static class UploadContentTypeHelper
{
    ...
    private static readonly ReadOnlyDictionary<string, string> CanonicalContentTypeMap =
    ...
    private static readonly ReadOnlyDictionary<string, ReadOnlyMemory<byte>> SupportedSignatures =
    ...
    public static bool TryGetCanonicalContentType(string? contentType, out string canonicalContentType)
    {
        ...
        if (CanonicalContentTypeMap.TryGetValue(contentType, out string? canonical))
        {
    ...
    {
        signature = default;
        return TryGetCanonicalContentType(contentType, out string? canonical)
